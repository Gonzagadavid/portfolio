const serFrontendProjects = {
  title: 'Projetos SerFrontend',
  projects: [
    {
    title: 'Lista de tarefas com JavaScript Puro',
    tec: 'js html css',
  ...
  {
    title: 'Lista de alunos (Model-View-Controller) com JavaScript Puro',
    tec: 'js html css',
...
export default serFrontendProjects;
