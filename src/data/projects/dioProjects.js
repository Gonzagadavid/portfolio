const dioProjects = {
  title: 'Projetos Digital Innovation One',
  projects: [
  {
    title: 'Projeto previsão do tempo com angular',
    tec: 'ts angular css',
  ...
  {
    title: 'Projeto Gerenciador de cursos com angular',
    tec: 'ts angular css',
  ...
  {
    title: 'Recriando a interface do NetFlix',
    tec: 'js html css',
